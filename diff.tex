...
%DIF DEL /dir/2024-12-04.tex   Wed Jan 22 00:03:01 2025
%DIF ADD /dir/new.tex          Wed Jan 22 00:03:01 2025
%% 
...
The content following USER INPUT represents the output from the query rewriter module.
}%DIFDELCMD < \begin{lstlisting}[style=prompt, label={lst:plan_prompt},caption={},aboveskip=0pt, belowskip=0pt]
%DIFDELCMD < %%%
%DIFAUXCMD NEXT
\DIFmodbegin
