...
%DIF DEL /dir/2024-12-04.tex   Wed Jan 22 00:48:15 2025
%DIF ADD /dir/new.tex          Wed Jan 22 00:48:15 2025
%% 
...
\DIFdelbegin %DIFDELCMD < \begin{lstlisting}[style=prompt, label={lst:param_prompt},caption={Parameters Identification prompt},numberstyle=\scriptsize,aboveskip=0pt, belowskip=0pt]
%DIFDELCMD < %%%
%DIFAUXCMD NEXT
\DIFmodbegin
...
%DIFDELCMD < %%%
%DIF <  The foundation of CWM is transforming user's natural language queries to a series of SQL commands for operating the database.
\DIFdelend \subsubsection{\DIFdelbegin \DIFdel{Few-shot learning}\DIFdelend \DIFaddbegin \DIFadd{Pre-planning operations}\DIFaddend }
