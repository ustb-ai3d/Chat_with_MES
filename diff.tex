...
%DIF DEL /dir/2024-12-04.tex   Tue Jan 21 23:56:40 2025
%DIF ADD /dir/new.tex          Tue Jan 21 23:56:40 2025
%% 
...
%DIFDELCMD < %%%
\DIFdelend \begin{lstlisting}[style=prompt, label={lst:param_prompt},caption={Parameters Identification prompt},numberstyle=\scriptsize,aboveskip=0pt, belowskip=0pt]
...
%DIFDELCMD < %%%
\DIFdelend %DIF >  The prompt adheres to the CO-STAR format, as demonstrated in xxx.
%DIF >  \lstset{
%DIF >   columns=fixed,       
